...
export function DetailViewSFT({name, description, priceHandler, listSFTHandler, balance, valueHandler, value}){
...
<div className='flex justify-center relative z-0'>
            <div className='flex w-full flex-col p-12 bg-[#ffffff] rounded-2xl shadow-2xl'>
              ...
              <input 
                ...
                <input 
                placeholder='balance'
                className='mt-8 border rounded p-2 w-[30%] text-center ring-2 ring-purple-500'
                value={value}
                disabled
                />
                </div>
...
export function ViewEditSFT({name, description, closeHandler, changeHandler, loading, editSFTHandler, nameChangeHandler, descriptionChangeHandler}){
