...
export default function NFTOwnershipTrackingTable({id}) {
    ...
    async function retrieveEvents(){
      ...
      let events_objects = [];
        ...
        const nft_events = await axios.get(`https://api-testnet.polygonscan.com/api?module=logs&action=getLogs&fromBlock=0&toBlock='latest'&address=${nftAddress}&topic0=0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef&topic3=${_hexId}&apikey=${polygonscan_api_key}`);

        let result = nft_events.data.result;
        ...
        for(let i=0; i<result.length; i++){
          ...
          events_objects[index] = {
            ...
            date: new Date(parseInt(nft_events.data.result[i].timeStamp, 16) * 1000).toLocaleDateString(),
        ...
        const marketplace_events = await axios.get(`https://api-testnet.polygonscan.com/api?module=logs&action=getLogs&fromBlock=0&toBlock='latest'&address=${marketplaceaddress}&topic0=0xe16c1a039cc3c09c08de243de5b9c8cd2f8a75d29e887c6a895af252529bbb75&topic1=${_hexId}&apikey=${polygonscan_api_key}`);
