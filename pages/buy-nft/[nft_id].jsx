...
export default function BuyNFT() {
    ...
    return (
        <><div className='w-full max-h-full gradient-bg-sec '>
            ...
            <div className='flex flex-col w-full gap-6 md:py-0'>
            ...
            <p className='px-4'>Sold by <a className='font-sans text-purple-700 hover:underline' style={{cursor:"pointer"}} target='_blank' href={`https://mumbai.polygonscan.com/address/${nft.seller}`}>{String(nft.seller).substring(0,24)}...</a></p>
            <hr className='w-full' />
